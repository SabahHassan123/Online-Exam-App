...
export default function LeftSide() {
  return (
    <section className='flex justify-center items-center flex-col p-10 bg-indigo-50 h-full '>
      <div className='w-3/4 leading-relaxed pb-10'>
        <h1 className='font-bold text-4xl leading-relaxed'>Welcome to <div className='text-indigo-700'>Elevate</div></h1>
