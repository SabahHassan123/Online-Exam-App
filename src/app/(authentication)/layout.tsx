...
export default function DashboardLayout({
  ...
  return (
    <section className="flex min-h-screen w-full bg-white">
      ...
      <div className="bg-indigo-50 lg:w-1/2 sm:w-0 md:w-0 xs:w-0 flex-1">
        <LeftSide />
      </div>
      ...
      <div className="bg-white lg:w-1/2 sm:w-full md:w-full xs:w-full">
        ...
        <div className="flex justify-end items-center gap-4 pr-6">
          <CLink href="signin" hyperText="Sign in" styles="font-medium" />
        ...
        <div className="w-full pt-5 flex justify-center ">
          <div className="w-3/5">
            ...
            <div className="flex items-center ">
              ...
              <span className="mx-3 text-gray-500 whitespace-nowrap text-sm">
                Or Continue with
              </span>
              <div className="w-full h-px bg-gray-300"></div>
            </div>
            ...
            <div className="flex justify-evenly">
              {socialMediaIcons.map((icon) => (
                <Button
                  ...
                  title={icon.iconName}
                  key={icon.id}
                  className={`${icon.iconName === "facebook" ? "text-facebookIconColor" : icon.iconName === "twitter" ? "text-twitterIconColor" : ""} rounded-xl shadow-md hover:shadow-xl`}
                >
                  {icon.icon}
                </Button>
              ))}
